...
class TrainingControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'training[duration]' => 'Testing',
            'training[extra_cost]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setExtra_cost('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'training[duration]' => 'Something New',
            'training[extra_cost]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getExtra_cost());
    }
